...
public class SeaShellsModule : MonoBehaviour
{
    ...
    private static readonly string[,] phrase = new string[3, 4] { { "she sells ", "she shells ", "sea shells ", "sea sells " }, { "sea\nshells ", "she\nshells ", "sea\nsells ", "she\nsells " }, { "sea shore", "she sore", "she sure", "seesaw" } };
    private static readonly string[,] buttonText = new string[4, 5] { { "she", "sit", "sushi", "shoe", "shih tzu" }, { "tutu", "can", "cancan", "2", "toucan" }, { "stitch", "twitch", "itch", "witch", "switch" }, { "burger", "llama", "armour", "bulgaria", "burglar alarm" } };

    private static readonly int[,] length = new int[4, 4] { { 7, 6, 7, 7 }, { 6, 6, 6, 5 }, { 5, 6, 5, 6 }, { 7, 5, 7, 5 } };
    private static readonly int[,,] table = new int[4, 4, 7] {{{1,3,0,1,3,0,1},{0,2,4,4,0,2,0},{4,0,2,4,0,2,4},{3,0,0,1,3,0,1}},
    ...
    private static readonly int[,] key = new int[4, 5] { { 3, 4, 0, 1, 2 }, { 1, 4, 0, 3, 2 }, { 3, 4, 2, 1, 0 }, { 4, 3, 2, 0, 1 } };
    private readonly int[] swap = new int[5];
    ...
    void Init()
    {
        ...
        for (int i = 0; i < buttons.Length; i++)
        {
            ...
            {
                buttons[j].AddInteractionPunch(0.3f);
                OnPress(swap[j] == key[keynum, table[row, col, step]]);
                return false;
            };
        }
